...
const PRODUCTS = [
  {
    ...
    variants:[
      { id:"paket-1", name:"Paket 1", price:30000, stock:10, type:"Private", warranty:"Full Garansi" }
    ],
  ...
  },
  {
    ...
    // Edit daftar variasi produk ini sesuai kebutuhan.
    variants:[
      { id:"paket-1", name:"Paket 1", price:32000, stock:10, type:"Private", warranty:"Full Garansi" }
    ],
  ...
  },
  {
    ...
    // Edit daftar variasi produk ini sesuai kebutuhan.
    variants:[
      { id:"paket-1", name:"Paket 1", price:15000, stock:10, type:"Private", warranty:"Full Garansi" }
    ],
   ...
   },
  {
    ...
    // Edit daftar variasi produk ini sesuai kebutuhan.
    variants:[
      { id:"paket-1", name:"Paket 1", price:13000, stock:10, type:"Private", warranty:"Full Garansi" }
    ],
  ...
  },
  {
    ...
    // Edit daftar variasi produk ini sesuai kebutuhan.
    variants:[
      { id:"paket-1", name:"Paket 1", price:45000, stock:10, type:"Private", warranty:"Full Garansi" }
    ],
    icon:"spark", img:"assets/vidio.png",
  ...
  },
  {
    ...
    // Edit daftar variasi produk ini sesuai kebutuhan.
    variants:[
      { id:"paket-1", name:"Paket 1", price:150000, stock:10, type:"Private", warranty:"Full Garansi" }
    ],
  ...
  },
  {
    ...
    // Edit daftar variasi produk ini sesuai kebutuhan.
    variants:[
      { id:"paket-1", name:"Paket 1", price:125000, stock:10, type:"Private", warranty:"Full Garansi" }
    ],
    icon:"unlock", img:"assets/imei.png",
